...
tweet_search <- paste(exploitsDB$platform, exploitsDB$type , sep=" ")

# Delete duplicated elements
tweet_search <- paste(unique(tweet_search), sep= ' ')
...
data = data.frame(platform = tweet_search, num_tweets)
